...
def diagram_login_methods():
    b = (
        ...
        + box(50, 100, 115, 45, "Google OAuth")
        + box(175, 100, 115, 45, "Microsoft OAuth")
        + box(300, 100, 115, 45, "Email + password")
        + box(425, 100, 115, 45, "Phone + SMS")
        + arrow(350, 60, 107, 100)
        + arrow(350, 60, 232, 100)
        + arrow(350, 60, 357, 100)
        + arrow(350, 60, 482, 100)
    )
