...
| **Public homepage** | Unauthenticated landing: hero, mission, events, announcements. |

See [Public site content](public-site-content.md), [About the school](about-school.md), [Parent portal](parent-portal.md).
